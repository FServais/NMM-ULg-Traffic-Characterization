...
# Number of bytes (in)
plot_to_file(file_name="ccdf_byts", title="CCDF of number of bytes", x=ibyts_base[:-1], y=1-ibyts_cumulative, xlabel="Number of bytes (in)", ylabel="Complementary Cumulative Probability Distribution")
plot_to_file(file_name="ccdf_byts_log", title="CCDF of number of bytes", x=ibyts_base[:-1], y=1-ibyts_cumulative, xlabel="Number of bytes (in)", ylabel="Complementary Cumulative Probability Distribution", scale='log')

# Number of packets (in)
plot_to_file(file_name="ccdf_pkts", title="CCDF of number of packets", x=ipkts_base[:-1], y=1-ipkts_cumulative, xlabel="Number of packets (in)", ylabel="Complementary Cumulative Probability Distribution")
plot_to_file(file_name="ccdf_pkts_log", title="CCDF of number of packets", x=ipkts_base[:-1], y=1-ipkts_cumulative, xlabel="Number of packets (in)", ylabel="Complementary Cumulative Probability Distribution", scale='log')
